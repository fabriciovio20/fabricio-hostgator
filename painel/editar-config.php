...
$query = $pdo->prepare("UPDATE $tabela SET nome = :nome, email = :email, telefone = :telefone, endereco = :endereco, telefone_fixo = :telefone_fixo, token = :token, instancia = :instancia, marca_dagua = :marca_dagua where id = 1");
