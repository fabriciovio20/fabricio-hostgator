        ...
        while (($dados = fgetcsv($objeto, 1000, ";")) !== FALSE) {
            ...
            if ($contadorLinha > 1) {
                ...
                if (count($dados) >= 4) {
                    ...
                    $query = $pdo->prepare("INSERT INTO $tabela SET registro = :registro, nome = :nome, filial = :filial, nivel = :nivel, ativo = 'Sim', telefone = :telefone, cpf = :cpf, foto = 'sem-foto.jpg', data = CURDATE(), email = :email");
