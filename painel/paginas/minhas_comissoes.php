		...
		<div class="col-md-2"  align="center">	
			<div > 
				<form action="rel/comissoes_class.php" target="_blank" method="POST">
					...
					<input type="" name="dataInicial" id="dataInicial">
					<input type="" name="dataFinal" id="dataFinal">
					<input type="" name="pago" id="pago_rel">
					<input type="" name="funcionario" value="<?php echo $id_func ?>">
