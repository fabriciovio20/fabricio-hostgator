...
<td class="esc">{$data_iniF}</td>
<td class="esc">{$qntd_dias}</td>
<td class="esc">{$data_fimF}</td>
<td class="esc"><div style="color:#FFF; background:{$imagemClasse}; padding:0px; width:75px; text-align: center; font-size: 12px; ">{$status1}</div></td>
